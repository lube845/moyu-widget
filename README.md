...
- **日历** — 今天的日期、农历干支纪年、距周五和下个法定节假日还有几天、本周/本月/本年鱼缸进度条
...
- 本周 / 本月 / 本年 三个鱼缸风格进度条（带 🐟 小鱼 emoji）
- 本月工作日总数、调休上班日提示、下个假期日期范围

### 饮水页（第 2 页）

- 8 个杯子按钮横排，点击空杯（蓝色脉冲的那个）记录一次饮水
- 点击刚喝的那一杯可以撤销
- 顶部右侧 `↺` 按钮手动归零；tag 在「目标 N 杯」和「已达标 🎉」之间切换
- 进度条复用日历页的鱼缸样式（带 💧 emoji）
